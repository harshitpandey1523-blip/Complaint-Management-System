...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 w-64 glass border-r border-border/50 flex flex-col">
      {/* Logo */}
      <div className="h-16 flex items-center gap-3 px-6 border-b border-border/50">
        ...
        <div>
          <h1 className="text-sm font-bold tracking-tight">ResolvX</h1>
          <p className="text-[10px] text-muted-foreground font-medium tracking-wider uppercase">Complaint Management</p>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-border/50">
        <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-muted/30">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-medium truncate">ResolvX v1.0</p>
            <p className="text-[10px] text-muted-foreground">E-Commerce Suite</p>
          </div>
        </div>
      </div>
    </aside>
